...
(defface ruby-font-lock-number-face
...
:group 'ruby-font-lock-faces)

(defface ruby-font-lock-properties-face
'((((class grayscale) (background light)) (:foreground "DimGray" :italic t))
  (((class grayscale) (background dark)) (:foreground "LightGray" :italic t))
  (((class color) (background light)) (:foreground "RosyBrown"))
  (((class color) (background dark)) (:foreground "LightSalmon"))
...
(defface ruby-font-lock-module-face
'((((class grayscale) (background light)) (:foreground "DimGray" :italic t))
  (((class grayscale) (background dark)) (:foreground "LightGray" :italic t))
  (((class color) (background light)) (:foreground "RosyBrown"))
  (((class color) (background dark)) (:foreground "LightSalmon"))
  (t (:italic t)))
"Font Lock mode face used to highlight modules."
:group 'ruby-font-lock-faces)

(defconst ruby-font-lock-number-face 'ruby-font-lock-number-face)
(defconst ruby-font-lock-properties-face 'ruby-font-lock-properties-face)
(defconst ruby-font-lock-module-face 'ruby-font-lock-module-face)
...
buffer position `limit' or the end of the buffer."
  ...
  (defconst ruby-font-lock-keywords
    (list
     ...
     ;; variables
     '("\\(\\$\\([^a-zA-Z0-9 \n]\\|[0-9]\\)\\)\\W"
       1 ruby-font-variable-name-face)
     ;;var
     '("^\\s *\\([^ |]+\\) *= *"
     ...
     '("\\(\\<[[:digit:]]+\\>\\)"
       ;; "^[^#]+?.*?\\(\\<[[:digit:]]+\\)"
       1 ruby-font-lock-number-face t)
     ...
     '("\\(^\\s *\\|[\[\{\(,]\\s *\\|\\sw\\s +\\)\\(\\(\\sw\\|_\\)+\\):[^:]" 2 ruby-font-lock-properties-face)
